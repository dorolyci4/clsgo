...
func Unset() {
	...
	fmt.Fprintf(StdOut, "%s[%dm", escape, Reset)
}
...
// string. Windows users should use this in conjunction with color.StdOut, example:
//
//	put := New(FgYellow).SprintFunc()
//	fmt.Fprintf(color.StdOut, "This is a %s", put("warning"))
...
// string. Windows users should use this in conjunction with color.StdOut.

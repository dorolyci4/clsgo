...
func TestColorVisual(t *testing.T) {
	...
	fmt.Fprintf(StdOut, "this is a %s and this is %s.\n", put("warning"), warn("error"))

	info := New(FgWhite, BgGreen).SprintFunc()
	fmt.Fprintf(StdOut, "this %s rocks!\n", info("package"))
	...
	fmt.Fprintln(StdOut, BlackString("black"))
	fmt.Fprintln(StdOut, RedString("red"))
	fmt.Fprintln(StdOut, GreenString("green"))
	fmt.Fprintln(StdOut, YellowString("yellow"))
	fmt.Fprintln(StdOut, BlueString("blue"))
	fmt.Fprintln(StdOut, MagentaString("magenta"))
	fmt.Fprintln(StdOut, CyanString("cyan"))
	fmt.Fprintln(StdOut, WhiteString("white"))
	fmt.Fprintln(StdOut, HiBlackString("hblack"))
	fmt.Fprintln(StdOut, HiRedString("hred"))
	fmt.Fprintln(StdOut, HiGreenString("hgreen"))
	fmt.Fprintln(StdOut, HiYellowString("hyellow"))
	fmt.Fprintln(StdOut, HiBlueString("hblue"))
	fmt.Fprintln(StdOut, HiMagentaString("hmagenta"))
	fmt.Fprintln(StdOut, HiCyanString("hcyan"))
	fmt.Fprintln(StdOut, HiWhiteString("hwhite"))
}
...
func TestNoFormatString(t *testing.T) {
	...
	colorString("test", 0xFF, "a", "b")
	colorPrint("test", 0xFF, "a", "b")
	testColor := New(FgBlack)
	testColor.EnableColor()
	testColor.DisableColor()
	testColor.wrap("test")
	testColor.SprintlnFunc()("test")
	testColor.FprintlnFunc()(StdError, "test")
	testColor.FprintfFunc()(StdError, "test")
	testColor.PrintFunc()("test")
	testColor.Sprint()
	testColor.Sprintln()
	testColor.Sprintf("test")
	testColor.Fprintf(StdError, "test")
	testColor.Fprintln(StdError, "test")
	testColor.unset()
	NoColor = true
	Unset()
	testColor.EnableColor()
	testColor.unsetWriter(StdError)
}
